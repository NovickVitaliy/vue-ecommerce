<template>
  ...
  <MDBFooter :text="['center', 'lg-start', 'muted']">
        ...
        <MDBRow class="mt-3">
          ...
          <MDBCol md="3" lg="4" xl="4" class="mx-auto mb-4">
            ...
            <h6 class="text-uppercase fw-bold mb-4">
              <i class="fas fa-gem me-3"></i>Group 343-2
            </h6>
            <p>
              <p>Новік Віталій Михайлович -
                <a href="https://github.com/NovickVitaliy" class="profile-link">GitHub profile</a>
              </p>

              <p>Гончарюк Вадим Віталійович -
                <a href="https://github.com/anavasynth" class="profile-link">GitHub profile</a>
              </p>
              <p>Греневич Іван Вікторович -
                <a href="https://github.com/Warded120" class="profile-link">GitHub profile</a>
              </p>
            </p>
          </MDBCol>
          <!-- Grid column -->
    ...
    <div class="text-center p-4" style="background-color: rgba(0, 0, 0, 0.05)">
      © 2024 Copyright:
      <a class="text-reset fw-bold" href="#!">secretstore.com</a>
    </div>
    <!-- Copyright -->
  </MDBFooter>
  <!-- Footer -->
